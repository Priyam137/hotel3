...
function Singleroom() {
  return (
    ...
    <div class="container single-room-container">
        <h2 class="room-heading">Single Room</h2>
        <div id="roomCarousel" class="carousel slide room-slider" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src={Room1} class="d-block w-100" alt="Single Room Photo 1"/>
                </div>
                <div class="carousel-item">
                    <img src={Room3} class="d-block w-100" alt="Single Room Photo 2"/>
                </div>
                <div class="carousel-item">
...
<a class="book-button-main" href="/room" role="button">Book single Room</a></div>
        </div>
